...
function App() {
  ...
  return (
    <div className="page">
      ...
      <PopupWithForm name={'edit-profile-popup'} title={'Редактировать профиль'} isOpen={isEditProfilePopupOpen} onClose={closeAllPopups}>
        <fieldset className="popup__forms" form="edit">
      ...
      <PopupWithForm name={'add-card-popup'} title={'Новое место'} isOpen={isAddPlacePopupOpen} onClose={closeAllPopups}>
        <fieldset className="popup__forms" form="add">
          <div className="popup__form-group">
      ...
      <PopupWithForm name={'edit-profile-image'} title={'Обновить аватар'} isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups}>
        <fieldset className="popup__forms" form="add">
          <div className="popup__form-group">
      ...
      <PopupWithForm name={'question-delete-card-popup'} title={'Вы уверены?'}>
        <fieldset className="popup__forms popup__forms_question" form="add">
